    ...
    variables.country == null ? "your country" : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/${
              variables.twitter == null ? "you twitter" : variables.twitter
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github == null ? "you github" : variables.github
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/school/${
              variables.linkedin == null ? "you linkedin" : variables.linkedin
